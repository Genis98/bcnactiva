    ...
    <div id="payment-box">
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr"
            ...
            <input type='hidden' name='business'
                value='sb-au8bc7300282@business.example.com'> <input type='hidden'
                ...
                name='notify_url'
                value='http://www.pruebapaypal.com.mialias.net/listen.php'>
            <input type='hidden' name='cancel_return'
                value='http://www.pruebapaypal.com.mialias.net/cancel.php'>
            <input type='hidden' name='return'
                value='http://www.pruebapaypal.com.mialias.net/return.php'>
